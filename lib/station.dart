...
class StationRepository {
  ...
  void saveCheckInStation(final String stationId) async {
    ...
    if (!checkInStatus){
      ...
      database.rawInsert('INSERT INTO checkin_stations(id) VALUES (?)', [stationId]);
    }
  }
  ...
  Future<List<Station>> getStations() async {
    ...
    final List<Station> stations = stationsJson.map((station) => Station.fromJson(station)).toList();
    return stations;
  }
